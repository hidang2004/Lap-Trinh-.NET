namespace lab03
{
    partial class FormCalculator
    {
		...
		private void InitializeComponent()
		{
			...
			label4.Location = new Point(64, 301);
			label4.Name = "label4";
			...
			txtSoN.Location = new Point(220, 103);
			txtSoN.Name = "txtSoN";
			txtSoN.Size = new Size(550, 51);
			txtSoN.TabIndex = 4;
			...
			txtSoM.Location = new Point(220, 198);
			txtSoM.Name = "txtSoM";
			txtSoM.Size = new Size(550, 51);
			txtSoM.TabIndex = 5;
			...
			txtKetQua.Location = new Point(220, 292);
			txtKetQua.Name = "txtKetQua";
			txtKetQua.ReadOnly = true;
			txtKetQua.Size = new Size(550, 51);
			txtKetQua.TabIndex = 6;
			txtKetQua.TextAlign = HorizontalAlignment.Right;
			// 
			// buttonCong
			// 
			buttonCong.Font = new Font("Segoe UI", 18F, FontStyle.Regular, GraphicsUnit.Point, 0);
			buttonCong.Location = new Point(12, 420);
			buttonCong.Name = "buttonCong";
			buttonCong.Size = new Size(124, 61);
			...
			// buttonTru
			// 
			buttonTru.Font = new Font("Segoe UI", 18F, FontStyle.Regular, GraphicsUnit.Point, 0);
			buttonTru.Location = new Point(169, 420);
			buttonTru.Name = "buttonTru";
			buttonTru.Size = new Size(122, 61);
			...
			// buttonNhan
			// 
			buttonNhan.Font = new Font("Segoe UI", 18F, FontStyle.Regular, GraphicsUnit.Point, 0);
			buttonNhan.Location = new Point(321, 420);
			buttonNhan.Name = "buttonNhan";
			buttonNhan.Size = new Size(123, 61);
			...
			// buttonChia
			// 
			buttonChia.Font = new Font("Segoe UI", 18F, FontStyle.Regular, GraphicsUnit.Point, 0);
			buttonChia.Location = new Point(470, 420);
			buttonChia.Name = "buttonChia";
			buttonChia.Size = new Size(125, 61);
			...
			// buttonXoa
			// 
			buttonXoa.Font = new Font("Segoe UI", 18F, FontStyle.Regular, GraphicsUnit.Point, 0);
			buttonXoa.Location = new Point(631, 420);
			buttonXoa.Name = "buttonXoa";
			buttonXoa.Size = new Size(126, 61);
			...
			// buttonThoat
			// 
			buttonThoat.Font = new Font("Segoe UI", 18F, FontStyle.Regular, GraphicsUnit.Point, 0);
			buttonThoat.Location = new Point(793, 420);
			buttonThoat.Name = "buttonThoat";
			buttonThoat.Size = new Size(120, 61);
